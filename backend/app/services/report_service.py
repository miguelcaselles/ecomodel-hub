...
class ReportService:
    ...
    def generate_pdf_report(
        ...
        story.append(Paragraph(f"Scenario: {scenario_name}", self.styles['Subtitle']))
        ...
        footer_text = "Generated by PharmEcon Platform - Professional Pharmacoeconomic Analysis"
    ...
    def generate_budget_impact_pdf(
        ...
        # Footer
        story.append(Spacer(1, 0.5*inch))
        footer_text = "Generated by EcoModel Hub - Professional Health Economic Analysis Platform"
        story.append(Paragraph(footer_text, self.styles['Subtitle']))
    ...
    def generate_decision_tree_pdf(
        ...
        # Footer
        story.append(Spacer(1, 0.5*inch))
        story.append(Paragraph("Generated by EcoModel Hub", self.styles['Subtitle']))
